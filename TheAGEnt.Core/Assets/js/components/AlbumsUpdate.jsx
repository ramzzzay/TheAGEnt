...
render : function() {
    return (
        <div className="Edit">
            ...
            <AutoComplete onUpdateInput={this._albumNameFieldChange} onNewRequest={this._albumNameFieldChange} floatingLabelText="showAllItems" filter={AutoComplete.fuzzyFilter} openOnFocus={true} dataSource={this.state.albums}/><br/>
