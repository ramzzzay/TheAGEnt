    ...
    render: function () {
        return (
            <div ref="SettingsPage">
                <Card>
                    <CardMedia overlay={< CardTitle title={<Av pathToPhoto={this.state.pathToPhoto}/>}
                                                    subtitle={`${this.state.name} ${this.state.surname}"s home`}/>}>
                        ...
                        <SwipeableViews index={this.state.slideIndex} onChangeIndex={this.handleChange}>
                            ...
                            <div style={styles.slide}>
                                <UpdateUserInfo changingUserInfo={this.changingUserInfo} email={this.state.email}
                                                ...
                                                nickname={this.state.nickname} address={this.state.address}/>
                            </div>
                            <div style={styles.slide}>
